...
const NavBar = ({ toogleDarkMode, darkMode }) => {
    ...
    const { checkAuth, isAuthenticated, logOut } = authStore();
  ...
  return (
    <div className="sticky hidden xl:flex items-start justify-end flex-1 ">
      <ul className="sticky top-10 flex w-5/6  flex-col gap-3 rounded-3xl border border-gray-400 bg-white p-5  dark:border-gray-700 dark:bg-black dark:text-white">
